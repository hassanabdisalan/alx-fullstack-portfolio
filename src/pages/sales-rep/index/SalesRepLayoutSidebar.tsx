...
import {
  SalesLayoutLinks,
  SalesLayoutSidebarBottomPanel,
} from "./salesRepSidebarLinks";

interface SalesRepLayoutSidebarProps {}
const delayDuration = 0.2;
export function SalesRepLayoutSidebar({}: SalesRepLayoutSidebarProps) {
  ...
  return (
    ...
    >
      ...
      >
        <SalesLayoutLinks open={open} />
        <SalesLayoutSidebarBottomPanel open={open} />
      </motion.div>
    </motion.div>
  );
}
