...
import {
  AdminLayoutLinks,
  AdminLayoutSidebarBottomPanel,
} from "./AdminLayoutSidebarLinks";

interface AdminLayoutSidebarProps {}
const delayDuration = 0.2;
export function AdminLayoutSidebar({}: AdminLayoutSidebarProps) {
  ...
  return (
    ...
    >
      ...
      >
        <AdminLayoutLinks open={open} />
        <AdminLayoutSidebarBottomPanel open={open} />
      </motion.div>
    </motion.div>
  );
}
