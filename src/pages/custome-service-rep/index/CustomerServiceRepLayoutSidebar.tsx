...
import {
  CustomerRepLayoutLinks,
  CustomerRepLayoutSidebarBottomPanel,
} from "./CustomerServiceRepSidebarLinks";

interface CustomerRepLayoutSidebarProps {}
const delayDuration = 0.2;
export function CustomerRepLayoutSidebar({}: CustomerRepLayoutSidebarProps) {
  ...
  return (
    ...
    >
      ...
      >
        <CustomerRepLayoutLinks open={open} />
        <CustomerRepLayoutSidebarBottomPanel open={open} />
      </motion.div>
    </motion.div>
  );
}
